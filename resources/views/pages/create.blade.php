                ...
                <div class="login-wrap">
                    <div class="login-content">
                        ...
                        @csrf
                                ...
                                <select class="form-control"name="category" value="0">
                               ...
                               @endforeach
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="au-input au-input--full" type="name" name="name" placeholder="News Name">
                                </div>
                                <div class="form-group">
                                    <label>News Title</label>
                                    <input class="au-input au-input--full" type="title" name="title" placeholder="News Title">
                                </div>
                                <div class="form-group">
                                    <label>News Content</label>
                                    <textarea class="au-input au-input--full" rows="3" cols="40" type="content" name="content" placeholder="News Content"></textarea>
                                </div>
